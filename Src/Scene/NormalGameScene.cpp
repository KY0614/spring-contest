...
NormalGameScene::NormalGameScene(void) :selectBlock(nullptr)
{
	InitBlock();
}
...
bool NormalGameScene::BlocksConnected(const BlockBase* block1, const BlockBase* block2) const
{
...
bool NormalGameScene::CheckConnections(const BlockBase* block) const
{
